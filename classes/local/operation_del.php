...
/**
 * Removes a user from a cohort, if currently a member.
 *
 * Assumes user and cohort have already been resolved by the caller.
 */
final class operation_del {
    /**
     * Remove the given user's membership in the given cohort.
     *
     * @param int $cohortid
     * @param int $userid
     * @param bool $dryrun
